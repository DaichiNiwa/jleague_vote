...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ action('admin\MatchesController@confirm') }}">
            ...
            @include('admin.matches.tournament_sub', ['tournament' => $match['tournament'], 'tournament_sub' => $match['tournament_sub']])
            ...
            <div class="form-group">
                ...
                <input id="team1_keyword" type="text" class="form-control @error('team1_keyword') is-invalid @enderror" name="team1_keyword" value="{{ old('team1_keyword' ,$match['team1_keyword']) }}" required>
            ...
            <div class="form-group">
                ...
                <input id="team2_keyword" type="text" class="form-control @error('team2_keyword') is-invalid @enderror" name="team2_keyword" value="{{ old('team2_keyword' ,$match['team2_keyword'])  }}" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="date" id="match_date" name="match_date" class="form-control col-4 @error('match_date') is-invalid @enderror" value="{{ old('match_date' ,$match['match_date']) }}" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="time" id="match_time" name="match_time" step="1800" min="09:00" max="20:00" class="form-control col-4 @error('match_time') is-invalid @enderror" value="{{ old('match_time' ,$match['match_time']) }}" required>
            ...
            <div class="form-check pb-3">
                ...
                <input class="form-check-input" type="checkbox" id="reserve" name="reserve" value="1" @if($match['reserve']==='1' || old('reserve')==='1') checked @endif>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="date" id="reserve_date" name="reserve_date" class="form-control col-4 @error('reserve_date') is-invalid @enderror" value="{{ old('reserve_date' ,$match['reserve_date']) }}">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="time" id="reserve_time" name="reserve_time" step="3600" class="form-control col-4 @error('reserve_time') is-invalid @enderror" value="{{ old('reserve_time' ,$match['reserve_time']) }}">
