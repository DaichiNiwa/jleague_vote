    ...
    <div class="card-body">
        <form method="POST" action="{{ action('admin\MatchesController@edit_confirm') }}">
            ...
            <div class="form-group">
                ...
                value="{{ old('team1_keyword' ,$match['team1_keyword']) }}" required>
            ...
            <div class="form-group">
                ...
                value="{{ old('team2_keyword' ,$match['team2_keyword'])  }}" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="date" id="match_date" name="match_date" class="form-control col-4 @error('match_date') is-invalid @enderror" 
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    class="form-control col-4 @error('match_time') is-invalid @enderror" value="{{ old('match_time' ,$match['match_time']) }}" required>
            ...
            @if($open_status === config('const.OPEN_STATUS.OPEN'))
            ...
            @else
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="date" id="reserve_date" name="reserve_date" class="form-control col-4 @error('reserve_date') is-invalid @enderror" 
                        value="{{ old('reserve_date' ,$match['reserve_date']) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="time" id="reserve_time" name="reserve_time" class="form-control col-4 @error('reserve_time') is-invalid @enderror" step="3600"
                        value="{{ old('reserve_time' ,$match['reserve_time']) }}">
